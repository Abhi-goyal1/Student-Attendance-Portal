    ...
    <div class="wrapper" style="background-color: aliceblue;">
        <div class="inner">
            <div class="image-holder">
                <img class="imgs" src="images/profec1.jpg" alt="">
            </div>
            <form action="Action\faculty-reg.php" method="post">
                <h3>Faculty Registration Form</h3>
                <div class="form-group">
                    <input type="text" placeholder="Full Name" name="full-name" required class="form-control">
                    <input type="number" placeholder="Phone " name="phone" required class="form-control">
                </div>
                <div class="form-wrapper">
                    <input type="text" placeholder="Faculty Id" name="faculty-id" required class="form-control">
                ...
                <button class="btn2" name="register">Register
