 <ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
     <a class="sidebar-brand d-flex align-items-center bg-white  justify-content-center" href="index.php">
         <div class="sidebar-brand-icon">
             <img src="img\logo 1 (1).png">
         </div>
         <!-- <div class="sidebar-brand-text mx-">Student Attendance Portal</div> -->
     </a>
